...
public class VNPAYService {
    ...
    public String createOrder(int total, String orderInfor, String urlReturn){
        ...
        urlReturn += VN_PayConfig.vnp_Returnurl;
        ...
        String vnp_SecureHash = VN_PayConfig.hmacSHA512(VN_PayConfig.vnp_HashSecret, hashData.toString());
    ...
    public int orderReturn(HttpServletRequest request){
        ...
        String signValue = VN_PayConfig.hashAllFields(fields);
