...
//    }
    ...
    public String tangdannam(Model model, @ModelAttribute("search2") SanPhamCustomerInfo info) {
        ...
        if (allUnchecked) {
            list = sanPhamCustomerRepository.loctangdan();
        } else {
            list = sanPhamCustomerRepository.searchByGender1(info.getIdThuongHieu(), info.getIdKichCo2());
        }
        model.addAttribute("listnam", list);
    ...
    public String giamdannam(Model model, @ModelAttribute("search2") SanPhamCustomerInfo info) {
        ...
        if (allUnchecked) {
            list = sanPhamCustomerRepository.locgiamdan();
        } else {
            list = sanPhamCustomerRepository.searchByGender1(info.getIdThuongHieu(), info.getIdKichCo2());
        }
        model.addAttribute("listnam", list);
    ...
    public String tangdannu(Model model, @ModelAttribute("search2") SanPhamCustomerInfo info) {
        ...
        if (allUnchecked) {
            list = sanPhamCustomerRepository.loctangdannu();
        } else {
            list = sanPhamCustomerRepository.searchByGender0(info.getIdThuongHieu(), info.getIdKichCo2());
        }
        model.addAttribute("listnu", list);
    ...
    public String giamdannu(Model model, @ModelAttribute("search2") SanPhamCustomerInfo info) {
        ...
        if (allUnchecked) {
            list = sanPhamCustomerRepository.locgiamdannu();
        } else {
            list = sanPhamCustomerRepository.searchByGender0(info.getIdThuongHieu(), info.getIdKichCo2());
        }
        model.addAttribute("listnu", list);
